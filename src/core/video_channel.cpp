        ...
        thread_ = std::thread([=] {
            ...
            while (!abort_request_) {
                try {
                    ...
                    auto          mixed_frame =
                        has_consumers ? mixer_(stage_frames.frames, stage_frames.layer_indices, stage_frames.format_desc, stage_frames.nb_samples)
                                               : const_frame{};
                    auto mixed_frame2 =
                        has_consumers && stage_frames.format_desc.field_count == 2
                            ? mixer_(stage_frames.frames2, stage_frames.layer_indices, stage_frames.format_desc, stage_frames.nb_samples)
                            : const_frame{};
